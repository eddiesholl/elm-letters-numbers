...
var _user$project$Models$isTargetValid = function (t) {
	var _p0 = t;
	if (_p0.ctor === 'Nothing') {
		return false;
	} else {
...
var _user$project$Models$inputInvalid = function (inp) {
	var _p1 = inp;
	if (_p1.ctor === 'Nothing') {
		return true;
	} else {
...
var _user$project$Models$anyInvalidInput = function (ins) {
	return A2(_elm_lang$core$List$any, _user$project$Models$inputInvalid, ins);
};
var _user$project$Models$isProblemReady = function (_p2) {
	var _p3 = _p2;
	var _p4 = _p3.inputs;
	return (!_user$project$Models$anyInvalidInput(_p4)) && (_user$project$Models$isTargetValid(_p3.target) && (_elm_lang$core$Native_Utils.cmp(
		_elm_lang$core$List$length(_p4),
		0) > 0));
};
var _user$project$Models$Model = F3(
	function (a, b, c) {
		return {problem: a, solution: b, state: c};
	});
var _user$project$Models$ProblemSetup = F2(
	function (a, b) {
		return {inputs: a, target: b};
	});
var _user$project$Models$SolutionSet = F2(
	function (a, b) {
		return {problem: a, solutions: b};
	});
var _user$project$Models$Solution = F4(
	function (a, b, c, d) {
		return {attempt: a, result: b, distance: c, length: d};
	});
var _user$project$Models$Pair = F2(
	function (a, b) {
		return {left: a, right: b};
	});
var _user$project$Models$PairedOperator = F2(
	function (a, b) {
		return {pair: a, op: b};
	});
var _user$project$Models$Done = {ctor: 'Done'};
var _user$project$Models$Running = {ctor: 'Running'};
var _user$project$Models$Waiting = {ctor: 'Waiting'};
var _user$project$Models$StartSolver = {ctor: 'StartSolver'};
var _user$project$Models$UpdateTarget = function (a) {
	return {ctor: 'UpdateTarget', _0: a};
};
var _user$project$Models$InvalidInput = {ctor: 'InvalidInput'};
var _user$project$Models$AddInput = {ctor: 'AddInput'};
var _user$project$Models$UpdateInput = F2(
	function (a, b) {
		return {ctor: 'UpdateInput', _0: a, _1: b};
	});
var _user$project$Models$InvalidProblem = {ctor: 'InvalidProblem'};
var _user$project$Models$ValidProblem = F2(
	function (a, b) {
		return {ctor: 'ValidProblem', _0: a, _1: b};
	});
var _user$project$Models$problemSetupToProblem = function (ps) {
	var _p5 = _user$project$Models$isProblemReady(ps);
	if (_p5 === true) {
		return A2(
			_user$project$Models$ValidProblem,
			A2(
				_elm_lang$core$List$map,
				_elm_lang$core$Maybe$withDefault(0),
				ps.inputs),
			A2(_elm_lang$core$Maybe$withDefault, 0, ps.target));
	} else {
		return _user$project$Models$InvalidProblem;
	}
};
var _user$project$Models$OpExp = function (a) {
	return {ctor: 'OpExp', _0: a};
};
var _user$project$Models$ConstExp = function (a) {
	return {ctor: 'ConstExp', _0: a};
};
var _user$project$Models$Multiply = {ctor: 'Multiply'};
var _user$project$Models$Subtract = {ctor: 'Subtract'};
var _user$project$Models$Add = {ctor: 'Add'};

var _user$project$Attempts$buildOpExp = F3(
	function (left, right, arg) {
		return _user$project$Models$OpExp(
			A2(
				_user$project$Models$PairedOperator,
				A2(_user$project$Models$Pair, left, right),
				arg));
	});
var _user$project$Attempts$inputsToConstants = _elm_lang$core$List$map(_user$project$Models$ConstExp);
var _user$project$Attempts$opReverse = function (op) {
	var _p0 = op;
	switch (_p0.ctor) {
		case 'Add':
			return false;
...
var _user$project$Attempts$applyArg = F3(
	function (left, right, arg) {
		var _p1 = _user$project$Attempts$opReverse(arg);
		if (_p1 === true) {
			return {
				ctor: '::',
				_0: A3(_user$project$Attempts$buildOpExp, left, right, arg),
				_1: {
					ctor: '::',
					_0: A3(_user$project$Attempts$buildOpExp, right, left, arg),
					_1: {ctor: '[]'}
				}
			};
		} else {
...
var _user$project$Attempts$applyArgs = F3(
	function (left, args, right) {
		return A2(
			_elm_lang$core$List$concatMap,
			A2(_user$project$Attempts$applyArg, left, right),
			args);
	});
var _user$project$Attempts$crossApplyExp = F3(
	function (subject, args, targets) {
		var applied = A2(
			_elm_lang$core$List$concatMap,
			A2(_user$project$Attempts$applyArgs, subject, args),
			targets);
		return A2(
			_elm_lang$core$Basics_ops['++'],
			{
			...
			A2(_elm_lang$core$Basics_ops['++'], targets, applied));
	});
var _user$project$Attempts$deriveExpressions = F2(
			...
			if (_p2._1.ctor === '::') {
				if (_p2._1._1.ctor === '[]') {
					...
					return A2(
						...
						A3(_user$project$Attempts$applyArgs, _p3, args, _p4));
				} else {
					return A3(
						_user$project$Attempts$crossApplyExp,
						_p2._0,
						args,
						A2(_user$project$Attempts$deriveExpressions, args, _p2._1));
				}
			} else {
				return {
					ctor: '::',
...
var _user$project$Attempts$generateAttempts = function (inputs) {
	return A2(
		_user$project$Attempts$deriveExpressions,
		{
			ctor: '::',
			_0: _user$project$Models$Add,
			_1: {
				ctor: '::',
				_0: _user$project$Models$Subtract,
				_1: {
					ctor: '::',
					_0: _user$project$Models$Multiply,
					_1: {ctor: '[]'}
				}
			}
		},
		_user$project$Attempts$inputsToConstants(inputs));
};

var _user$project$Solver$evalExpression = function (e) {
	var _p0 = e;
	if (_p0.ctor === 'ConstExp') {
		return _p0._0;
	} else {
		var _p1 = _p0._0;
		return A3(_user$project$Solver$evalPair, _p1.pair.left, _p1.pair.right, _p1.op);
	}
};
var _user$project$Solver$evalPair = F3(
	function (e1, e2, op) {
		var eval2 = _user$project$Solver$evalExpression(e2);
		var eval1 = _user$project$Solver$evalExpression(e1);
		var _p2 = op;
		switch (_p2.ctor) {
			case 'Subtract':
				return eval1 - eval2;
...
var _user$project$Solver$expLength = function (e) {
	var _p3 = e;
	if (_p3.ctor === 'ConstExp') {
		return 1;
	} else {
		var _p4 = _p3._0;
		return _user$project$Solver$expLength(_p4.pair.left) + _user$project$Solver$expLength(_p4.pair.right);
	}
};
var _user$project$Solver$calculateResult = F2(
	function (target, e) {
		var result = _user$project$Solver$evalExpression(e);
		return {
			attempt: e,
			result: _user$project$Solver$evalExpression(e),
			distance: _elm_lang$core$Basics$abs(target - result),
			length: _user$project$Solver$expLength(e)
		};
	});
var _user$project$Solver$calculateResults = F2(
	function (target, attempts) {
		return A2(
			_elm_lang$core$List$map,
			_user$project$Solver$calculateResult(target),
			attempts);
	});
var _user$project$Solver$compareResults = F2(
	function (a, b) {
		var _p5 = A2(_elm_lang$core$Basics$compare, a.distance, b.distance);
		if (_p5.ctor === 'EQ') {
			return A2(_elm_lang$core$Basics$compare, a.length, b.length);
		} else {
			return _p5;
		}
	});
var _user$project$Solver$sortResults = function (solutions) {
	return A2(_elm_lang$core$List$sortWith, _user$project$Solver$compareResults, solutions);
};
var _user$project$Solver$solve = function (problem) {
	var _p6 = problem;
	if (_p6.ctor === 'InvalidProblem') {
		return _elm_lang$core$Maybe$Just(
			{
				problem: problem,
				solutions: A2(
					_user$project$Solver$calculateResults,
					0,
					_user$project$Attempts$generateAttempts(
						{
							ctor: '::',
							_0: -1,
							_1: {ctor: '[]'}
		...
		return _elm_lang$core$Maybe$Just(
			{
				problem: problem,
				solutions: _user$project$Solver$sortResults(
					A2(
						_user$project$Solver$calculateResults,
						_p6._1,
						_user$project$Attempts$generateAttempts(_p6._0)))
			});
	}
};

var _user$project$Styles$rowSpacer = {
	ctor: '::',
	_0: _rtfeldman$elm_css$Css$minWidth(
		_rtfeldman$elm_css$Css$px(20)),
	_1: {ctor: '[]'}
};
var _user$project$Styles$page = {
	ctor: '::',
	_0: _rtfeldman$elm_css$Css$margin(
		_rtfeldman$elm_css$Css$px(20)),
	_1: {ctor: '[]'}
};
var _user$project$Styles$flexRow = {
	ctor: '::',
...
var _user$project$Styles$flexColumn = {
	ctor: '::',
	_0: _rtfeldman$elm_css$Css$displayFlex,
	_1: {
		ctor: '::',
...
var _user$project$Styles$Page = {ctor: 'Page'};

var _user$project$Render$opToText = function (op) {
	var _p0 = op;
	switch (_p0.ctor) {
		case 'Add':
			return '+';
...
var _user$project$Render$expressionToText = function (e) {
	var _p1 = e;
	if (_p1.ctor === 'ConstExp') {
		...
		return A2(
			...
			A2(
				_elm_lang$core$Basics_ops['++'],
				_user$project$Render$expressionToText(_p2.pair.left),
				A2(
					_elm_lang$core$Basics_ops['++'],
					' ',
					A2(
						_elm_lang$core$Basics_ops['++'],
						_user$project$Render$opToText(_p2.op),
						A2(
							_elm_lang$core$Basics_ops['++'],
							' ',
							A2(
								_elm_lang$core$Basics_ops['++'],
								_user$project$Render$expressionToText(_p2.pair.right),
								' )'))))));
	}
};
var _user$project$Render$renderExpression = function (e) {
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: _elm_lang$html$Html$text(
				_user$project$Render$expressionToText(e)),
			_1: {ctor: '[]'}
		});
};
...
var _user$project$Main$rowSpacer = A2(
	_elm_lang$html$Html$div,
	{
		ctor: '::',
		_0: _user$project$Styles$styles(_user$project$Styles$rowSpacer),
		_1: {ctor: '[]'}
	},
	{ctor: '[]'});
var _user$project$Main$textDiv = function (t) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
...
var _user$project$Main$solutionRow = function (solution) {
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _user$project$Render$renderExpression(solution.attempt),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _user$project$Main$textDiv(solution.result),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: _user$project$Main$textDiv(solution.distance),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}
...
var _user$project$Main$solutionsView = function (solution) {
	var _p0 = solution;
	if (_p0.ctor === 'Nothing') {
		return A2(
			_elm_lang$html$Html$div,
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text('No solution yet'),
				_1: {ctor: '[]'}
			});
	} else {
		var _p1 = _p0._0;
				...
				_0: _elm_lang$html$Html$text(
					A2(
						...
						_elm_lang$core$Basics$toString(
							_elm_lang$core$List$length(_p1.solutions)),
						' solutions')),
				_1: {
					ctor: '::',
					_0: A2(
						...
						},
						{
							...
							_1: {
								...
								_0: A2(
									...
									{ctor: '[]'},
									A2(_elm_lang$core$List$map, _user$project$Main$solutionRow, _p1.solutions)),
								_1: {ctor: '[]'}
							}
						}),
					_1: {ctor: '[]'}
...
var _user$project$Main$solverView = function (_p2) {
	var _p3 = _p2;
	var canStart = function () {
		...
		if (_p4.ctor === 'Running') {
			...
			return _user$project$Models$isProblemReady(_p3.problem);
		}
	}();
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Solver'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					_elm_lang$html$Html$button,
					{
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onClick(_user$project$Models$StartSolver),
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$disabled(!canStart),
									_1: {ctor: '[]'}
								}
							}
						}
				...
				_1: {
					ctor: '::',
					_0: _user$project$Main$solutionsView(_p3.solution),
					_1: {ctor: '[]'}
				}
			}
		});
};
var _user$project$Main$inputDisplay = function (inp) {
	var _p5 = inp;
	if (_p5.ctor === 'Just') {
...
var _user$project$Main$targetTyped = function (input) {
	var _p6 = input;
	if (_p6 === '') {
		return _user$project$Models$UpdateTarget(_elm_lang$core$Maybe$Nothing);
	} else {
		var _p7 = _elm_lang$core$String$toInt(input);
		if (_p7.ctor === 'Ok') {
			return _user$project$Models$UpdateTarget(
				_elm_lang$core$Maybe$Just(_p7._0));
		} else {
			return _user$project$Models$InvalidInput;
		}
	}
};
var _user$project$Main$inputTyped = F2(
	function (ix, input) {
		var _p8 = input;
		if (_p8 === '') {
			return A2(_user$project$Models$UpdateInput, ix, _elm_lang$core$Maybe$Nothing);
		} else {
			var _p9 = _elm_lang$core$String$toInt(input);
			if (_p9.ctor === 'Ok') {
				return A2(
					_user$project$Models$UpdateInput,
					ix,
...
var _user$project$Main$inputView = F2(
	function (ix, inp) {
		return A2(
			_elm_lang$html$Html$div,
			{ctor: '[]'},
				...
				_0: A2(
					_elm_lang$html$Html$input,
					{
						...
						_0: _elm_lang$html$Html_Events$onInput(
							_user$project$Main$inputTyped(ix)),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$value(
								_user$project$Main$inputDisplay(inp)),
							_1: {ctor: '[]'}
						}
					},
					{ctor: '[]'}),
...
var _user$project$Main$inputsView = function (problem) {
	var validTarget = _user$project$Models$isTargetValid(problem.target);
	var invalidInput = _user$project$Models$anyInvalidInput(problem.inputs);
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onInput(_user$project$Main$targetTyped),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$value(
								_user$project$Main$inputDisplay(problem.target)),
							_1: {ctor: '[]'}
						}
					},
					{ctor: '[]'}),
				_1: {
					...
					_1: {
						...
						_0: A2(
							_elm_lang$html$Html$div,
							{ctor: '[]'},
							A2(_elm_lang$core$List$indexedMap, _user$project$Main$inputView, problem.inputs)),
						_1: {
							ctor: '::',
							_0: A2(
								_elm_lang$html$Html$button,
								{
									...
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Events$onClick(_user$project$Models$AddInput),
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$disabled(invalidInput),
											_1: {ctor: '[]'}
										}
									}
								},
...
var _user$project$Main$view = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _user$project$Styles$styles(_user$project$Styles$page),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Letters and Numbers Solver'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _user$project$Main$inputsView(model.problem),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: _user$project$Main$solverView(model),
					_1: {ctor: '[]'}
				}
			}
		});
};
var _user$project$Main$alterInput = F3(
	function (inputs, ix, newVal) {
		var _p10 = _elm_lang$core$List$head(inputs);
		if (_p10.ctor === 'Nothing') {
			return inputs;
		} else {
			var _p14 = _p10._0;
			var _p11 = _elm_lang$core$List$tail(inputs);
			if (_p11.ctor === 'Nothing') {
				...
				var _p12 = ix;
				if (_p12 === 0) {
					return {ctor: '::', _0: newVal, _1: _p13};
				} else {
					return {
						ctor: '::',
						_0: _p14,
						_1: A3(_user$project$Main$alterInput, _p13, ix - 1, newVal)
					};
				}
			}
		}
...
var _user$project$Main$update = F2(
	function (msg, model) {
		...
		switch (_p15.ctor) {
			case 'UpdateInput':
				var oldProblem = model.problem;
				var newProblem = _elm_lang$core$Native_Utils.update(
					oldProblem,
					{
						inputs: A3(_user$project$Main$alterInput, oldProblem.inputs, _p15._0, _p15._1)
					});
				return {
					ctor: '_Tuple2',
			...
			default:
				var newSolution = _user$project$Solver$solve(
					_user$project$Models$problemSetupToProblem(model.problem));
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{solution: newSolution, state: _user$project$Models$Done}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
		}
	});
var _user$project$Main$init = {
	...
	_0: A3(
		...
		A2(
			_user$project$Models$ProblemSetup,
			{
				ctor: '::',
				_0: _elm_lang$core$Maybe$Just(45),
				_1: {
					ctor: '::',
			...
			_elm_lang$core$Maybe$Just(634)),
		_elm_lang$core$Maybe$Nothing,
		_user$project$Models$Waiting),
	_1: _elm_lang$core$Platform_Cmd$none
};
